...
# @File: The Vampires.py
# @Time: 2019/02/18 23:28:02
...
def fight(unit_1, unit_2):
    damage1 = unit_1.attack - unit_2.defense
    if damage1 < 0:
        damage1 = 0
    damage2 = unit_2.attack - unit_1.defense
    if damage2 < 0:
        damage2 = 0
    while unit_1.is_alive and unit_2.is_alive:
        unit_2.health -= damage1
        unit_1.health += unit_1.vampirism * damage1
        if unit_2.is_alive:
            unit_1.health -= damage2
            unit_2.health += unit_2.vampirism * damage2
